    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Each dot represents an elderly resident in the HAL-MONI pilot across Jeongseon-gun,
          Yanggu-gun, and Inje-gun. Colours correspond to counties.
        </p>
          ...
          >
            ...
            {elderlyData.map((elder) => (
              <CircleMarker
                ...
                pathOptions={{
                  color: getCountyColor(elder.county),
                  fillColor: getCountyColor(elder.county),
                  fillOpacity: 0.9,
                }}
                eventHandlers={{
                  click: (_e: LeafletMouseEvent) => handleMarkerClick(elder),
                }}
              >
                <Tooltip direction="top" offset={[0, -4]} opacity={1}>
                  {elder.nameEn} — {elder.riskScore}
                </Tooltip>
              </CircleMarker>
            ))}
          </MapContainer>
    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-600 mb-6">
          Monitor and respond to elderly residents in your assigned area
        </p>
            ...
            <div
              ...
              className={`p-4 border-2 rounded-lg cursor-pointer transition-all hover:shadow-lg ${
                selectedElder?.id === elder.id
                  ...
                  : getRiskBorderColor(elder.riskLevel)
              }`}
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-white text-sm ${getRiskColor(
                        elder.riskLevel,
                      )}`}
                    >
